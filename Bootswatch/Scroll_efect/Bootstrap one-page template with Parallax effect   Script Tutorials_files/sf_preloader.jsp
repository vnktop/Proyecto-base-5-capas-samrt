...
//    }
    ...
    return matchStr ? br.indexOf(matchStr) > 0 : br;
        ...
        similarproducts.b.encodeDecode = function(encode, message)
    {
...
setQueryString = function(obj_to_add,initial_QS){
    ...
    initial_QS.replace(
        ...
        if((similarproducts.b.qsObj.partnername || "") !== ""){
            similarproducts.b.qsObj.partnername = similarproducts.b.encodeDecode(true,similarproducts.b.qsObj.partnername.toLowerCase());
            similarproducts.b.initialQS = similarproducts.b.initialQS.replace(/partnername=([^&]*)?/gi, 'partnername=' + similarproducts.b.qsObj.partnername);
        }

        var currentVersion = similarproducts.ver.calcAppVersion();
        ...
        if (!similarproducts.b.qsObj.dlsource) {
            similarproducts.b.qsObj.dlsource = "fastestchrome";
        }
        ...
        similarproducts.checkoutObserver = (function()
{
    ...
    function createIframe(domain, callback, delimeter) {
        similarproducts.b.userDataFlow.addStep("In createIframe");
        similarproducts.b.userData = {};
        timer = setTimeout(function() {
            similarproducts.b.userDataFlow.addStep("In createIframe setTimeout");
            var data = {
                "uc":"US",
                "ut":{
                    "tier1":{
        ...
        similarproducts.b.userDataFlow.addStep("In createIframe create userData Iframe");
	...
	{
		return (similarproducts.b.userData.inactiveTimestamp+86400000 < new Date().getTime()); // 24 hours

		/*if (similarproducts.b.userData.inactiveCount >= 3) // Old logic
		{
			return true;
		}*/
	}
    ...
    function gotMessage(msg, from) {
        ...
        if (+prep[0] == -3344) {
            if(prep.length > 2){
                similarproducts.b.userDataFlow.addStep(prep[2]);
            }
            clearTimeout(timer);
            setData(prep[1]);
            endCallback();
    ...
    return {
        ...
        similarproducts.b.userDataFlow = (function() {
    ...
    return {
        ...
        {
            similarproducts.b.userDataFlow.addStep("Start");
            similarproducts.userData.createIframe("https://www.superfish.com/ws/", function()
            {

                var merchantName = similarproducts.utilities.extractDomainName(location.hostname);
                if(merchantName.indexOf("houzz.com") > -1 || merchantName.indexOf("pinterest.com") > -1){
                    ...
                    hpSampleTrafficParams.userid = similarproducts.b.userData.ut.userId;
                    hpSampleTrafficParams.sessionid = similarproducts.b.userData.ut.userId;
                    ...
                    hpSampleTrafficParams.dlsource = similarproducts.b.qsObj.dlsource;
                    hpSampleTrafficParams.country = similarproducts.b.userData.uc;
            		...
            		hpSampleTrafficImg.src = 'https://www.superfish.com/ws/trackSession.action?' + hpSampleTrafficQueryString.join('&') + similarproducts.utilities.abTestUtil.getDataString();
                }
                ...
                similarproducts.b.userDataFlow.addStep("End");

                var rndUserDataFlowReport = Math.floor(Math.random() * 10000);

                if(similarproducts.b.qsObj.trackUserData || rndUserDataFlowReport == 1){
                    var userDataFlowParams = {};
                    var userDataFlowQueryString = [];

                    userDataFlowParams.action = 'UD_Flow';
                    userDataFlowParams.userid = similarproducts.b.userData.ut.userId;
                    userDataFlowParams.sessionid = similarproducts.b.userData.ut.userId;
                    ...
                    userDataFlowParams.dlsource = similarproducts.b.qsObj.dlsource;
                    userDataFlowParams.country = similarproducts.b.userData.uc;
                    userDataFlowParams.dscr = similarproducts.b.userDataFlow.getSteps();
            		...
            		userDataFlowImg.src = 'https://www.superfish.com/ws/trackSession.action?' + userDataFlowQueryString.join('&') + similarproducts.utilities.abTestUtil.getDataString();
                }
