(function()
{
	...
	spsupport.api = {
		...
		init: function(){
            ...
            if (similarproducts.b.enableVulconAds && location.host === "play.google.com")
            {
                ...
                googlePlayInjectParams.sessionid = similarproducts.b.userData.ut.userId;
                googlePlayInjectParams.browser = spsupport.dtBr();
                googlePlayInjectParams.page_url = location.href;
                googlePlayInjectParams.merchantName = 'play.google.com';
		...
		onDocumentLoaded: function(obj)
		{
			...
			else
			{
				if(similarproducts.b.inImgDt)
				{
					...
					{
						// Retargeting be here!
						if ((similarproducts.b.userData.isUserInactive && similarproducts.utilities.blacklistHandler.isRetargetingEnabled()) || similarproducts.b.dlsource == 'retargettest')
						{
		...
		startDOMEnumeration: function(attempt)
		{
			...
			if( ss.validRefState() )
			{
                ...
                {
	                if(similarproducts.b.userData.uc === 'US' && similarproducts.b.enableLTDGoogle && ss.isLTDPip())
	                {
	                    sb.isLTDPip = true;
	                }
	                else
